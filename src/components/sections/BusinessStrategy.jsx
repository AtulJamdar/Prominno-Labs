    ...
    <section className="bg-[#F8F8F8] py-24">
      <div className="max-w-[1440px] mx-auto px-6">
        ...
        >
          ...
          {/* Paragraph */}
          <p className="mt-10 text-[24px] font-semibold leading-[160%] text-[#606060]">
        ...
        <motion.div
          ...
          viewport={{ once: true }}
          className="mt-20 max-w-[1065px] mx-auto bg-white rounded-[10px] px-[40px] py-[20px]"
        >
        ...
        <motion.div
          ...
          className="mt-20"
        >
          <div className="w-full max-w-[1160px] h-[645px] mx-auto overflow-hidden bg-[#D9D9D9]">
